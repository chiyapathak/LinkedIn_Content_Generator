...
st.markdown('<div class="influencer-names"><span class="influencer-name">Chitra</span></div>', unsafe_allow_html=True)
...
post_templates = {
    "Resilience": {
        "Short": "Hi, my name is Chitra, and I am testing my frontend. #internship, #MECON ",
        "Medium": "This is for Medium length, Hi, my name is Chitra, and I am testing my frontend. #internship, #MECON",
        "Long": "This is for Long Length, Hi my name is Chitra, and I am testing my frontend. #internship, #MECON "
    },
    "Leadership": {
        "Short": "Hi, my name is Chitra, and I am testing my frontend. #internship, #MECON ",
        "Medium": "This is for Medium length, Hi, my name is Chitra, and I am testing my frontend. #internship, #MECON",
...
if st.button("Generate Post"):
    try:
        ...
        # Display result
        # Prepare the content outside the f-string
        post_content_html = post_content.replace('\n', '<br>')

        # Then use it safely inside the f-string
        st.markdown(f"""
